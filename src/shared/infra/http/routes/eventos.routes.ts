...
import { FindVendaByIdController } from "../../../../modules/eventos/useCases/findVendaById/FindVendaByIdController";
...
eventosRouter.get("/venda/:id", findVendaByIdController.handle);
